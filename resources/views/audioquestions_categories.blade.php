          ...
          <div class="row">
            ...
            <div class="card" style="margin: 5px;">
              ...
              <div class="card-body">
                ...
                <a href="{{ route('audioquestions.subcategories', ['category'=>$category->id]) }}" class="btn btn-primary btn-sm"><i class="fas fa-eye"></i> Choose A Subcategory</a>
              </div>
            </div>
            </div>
            @endforeach

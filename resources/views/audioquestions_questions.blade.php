        ...
        <div class="card-body col-lg-12">
            ...
            <div class="modal-dialog" role="document">
              <div class="modal-content">
                ...
                <div class="modal-body">
                  <form enctype="multipart/form-data" method="POST" action="{{ route('audioquestions.questions.add') }}">
                    @csrf
                    ...
                    <div class="form-group text-left">
                      ...
                      <input name="question_audio_url" type="file" class="form-control">
                    </div>
                    <div class="form-group text-left">
          ...
          <div class="row no-gutters align-items-center table-responsive">
            <table class="table table-bordered">
              <thead>
                <tr>
                  <th class="align-middle text-center" scope="col">Question Audio</th>
              ...
              <tbody>
                ...
                <tr><td class="align-middle text-center">
                  <a style="font-size: 12px !important;" href="{{ asset('uploads/questions/'.$question->question_audio_url) }}" target="_blank">{{ asset('uploads/questions/'.$question->question_audio_url) }}</a>
              </td>
              ...
              <td class="align-middle text-center">
                ...
                <!-- Delete Player Modal-->
                <form enctype="multipart/form-data" method="POST" action="{{ route('audioquestions.question.delete', ['question'=>$question->id]) }}">
                  @csrf
              ...
              <div class="modal fade" id="editModal{{$question->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog" role="document">
                  <div class="modal-content">
                    ...
                    <div class="modal-body">
                      <form method="POST" enctype="multipart/form-data" action="{{ route('audioquestions.questions.update', ['id'=>$question->id]) }}">
                        @csrf
                        <div class="form-group text-left">
                          <label>Question Audio</label>
                          <br>

          ...
          <div class="row">
            ...
            <div class="card" style="margin: 5px;">
              ...
              <div class="card-body">
                ...
                <a href="{{ route('textquestions.questions', ['category'=>$quiz->category_id, 'subcategory'=>$quiz->subcategory_id, 'quiz'=>$quiz->id]) }}" class="btn btn-primary btn-sm"><i class="fas fa-eye"></i> Manage Text Questions</a>
              </div>
            </div>
            </div>
            @endforeach

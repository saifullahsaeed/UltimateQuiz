...
namespace App\Http\Resources\AudioQuestions;
...
class AudioQuestionsCollection extends JsonResource
{
    /**
    ...
    public function toArray($request)
    {
        ...
        'false2'=>$this->false2,  
        'false3'=>$this->false3,  
        'question_audio_url'=>URL::to('uploads/questions/'.$this->question_audio_url),  
